...
提供一个选择题来确定级别。请用户从COCA 1000-5000、5001-8000、8001-12000、12001-20000中选择他们适合的范围。
...
请列出10个单词和样例句子。询问用户是否知道其中7个以上的意思在他们的母语中。如果超过7个，您可以确认他/她达到这个水平。
...
每次为下面的文本中的一个新词汇提供5个新的例句。让用户猜测意思，然后解释该单词并提供英语发音符号。
